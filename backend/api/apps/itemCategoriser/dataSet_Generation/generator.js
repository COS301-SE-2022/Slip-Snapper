...
async function cleanGroceries(){
    const groceries = fs.createReadStream('./Groceries_dataset.csv')
...
async function cleanPrice(){
    const price = fs.createReadStream('./pricerunner_aggregate.csv')
...
async function cleanShop(){
    const shop = fs.createReadStream('./shopmania.csv')
    ...
    .on("end", function () {
        console.log("finished");
        console.table(shopResults)
    });
}

async function cleanSkroutz(){
    const skroutz = fs.createReadStream('./skroutz_aggregate.csv')
